...
export default function ProductPage() {
  return (
    <div style={{ minHeight: "100dvh", background: "#F5F1E8", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "48px" }}>
      ...
      <h1 style={{ fontFamily: "var(--font-cormorant), serif", fontWeight: 300, fontSize: "56px", margin: "0 0 16px", letterSpacing: "-0.01em" }}>Product</h1>
      <p style={{ color: "#6B6258", fontSize: "15px", margin: "0 0 32px" }}>Coming soon.</p>
